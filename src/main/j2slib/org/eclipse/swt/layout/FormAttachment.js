...
$_M(c$,"divide",
function(value){
return new $wt.layout.FormAttachment(this.numerator,this.denominator*value,$_dI(this.offset/value));
},"~N");
$_M(c$,"gcd",
function(m,n){
var temp;
...
solution.numerator=$_dI(solution.numerator/gcd);
solution.denominator=$_dI(solution.denominator/gcd);
...
$_M(c$,"solveX",
function(value){
return($_dI((this.numerator*value)/this.denominator))+this.offset;
},"~N");
$_M(c$,"solveY",
function(value){
return $_dI((value-this.offset)*this.denominator/this.numerator);
},"~N");
$_V(c$,"toString",
function(){
