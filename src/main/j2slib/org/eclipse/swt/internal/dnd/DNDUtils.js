$_L(null,"$wt.internal.dnd.DNDUtils",["$wt.internal.browser.OS","$wt.internal.dnd.DragEvent","$.HTMLEventWrapper"],function(){
...
Clazz.addEvent(document,O$.isMobile?"touchmove":"mousemove",oThis.hMouseMove);
...
Clazz.addEvent(document,O$.isMobile?"touchend":"mouseup",oThis.hMouseUp);
}var isOpera=false;
{
