$_L(null,"$wt.internal.dnd.DragAndDrop",["$wt.internal.browser.OS","$wt.internal.dnd.DNDUtils"],function(){
c$=$_C(function(){
this.status=0;
this.element=null;
this.startX=0;
...
Clazz.removeEvent(document,O$.isMobile?"touchmove":"mousemove",this.hMouseMove);
this.hMouseMove=null;
}if(this.hMouseUp!=null){
Clazz.removeEvent(document,O$.isMobile?"touchend":"mouseup",this.hMouseUp);
this.hMouseUp=null;
}if(this.hKeyUp!=null){
...
Clazz.addEvent(el,O$.isMobile?"touchstart":"mousedown",this.hMouseDown);
}},"Element");
$_M(c$,"unbind",
function(){
if(this.hMouseDown!=null){
Clazz.removeEvent(this.element,O$.isMobile?"touchstart":"mousedown",this.hMouseDown);
this.hMouseDown=null;
}this.element=null;
});
$_M(c$,"checkDraggable",
