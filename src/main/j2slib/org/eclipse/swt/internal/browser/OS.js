...
}}}else if(O$.isOpera||O$.isSafari||O$.isIE80){
if((style&(147456))!=0){
s.top="1px";
if((style&131072)!=0){
s.left="1px";
...
ch=String.fromCharCode(keyCode+97-65);
}else{
ch=String.fromCharCode(keyCode);
}}else if(keyCode>=96&&keyCode<=105){
ch=String.fromCharCode(keyCode-96+48);
...
os.isSafari=dua.indexOf("Safari")>=0||dua.indexOf("AppleWebKit")>=0;
os.isMobile=dua.indexOf("Mobile")>=0;
os.isOSX=dua.indexOf("OS X")>=0;
