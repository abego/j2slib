...
if((this.style&8)!=0&&!this.isSimple){
Clazz.addEvent(this.textInput,"click",this.hEditShow);
...
var buttonWidth=Math.min(16,height-2);
this.dropDownButton.style.width=buttonWidth+"px";
if(O$.isMobile){
this.textInput.style.paddingRight=buttonWidth+4+"px";
this.textInput.style.width=Math.max(0,width-buttonWidth-3-4)+"px";
this.textInput.style.height=Math.max(0,height-7)+"px";
this.textInput.style.lineHeight=Math.max(0,height-7)+"px";
}else{
this.textInput.style.paddingRight=buttonWidth+3+"px";
this.textInput.style.width=Math.max(0,width-buttonWidth-3-4)+"px";
...
if(O$.isOSX){
this.textInput.style.width=Math.max(0,width-buttonWidth-6-4)+"px";
this.textInput.style.height=Math.max(0,height-8)+"px";
this.textInput.style.lineHeight=Math.max(0,height-8)+"px";
}else{
this.textInput.style.width=Math.max(0,width-buttonWidth-6)+"px";
...
this.dropDownButton.childNodes[0].style.marginTop="-6px";
this.textInput.style.marginTop="0";
}}else{
...
if(O$.isFirefox){
this.dropDownButton.style.top=O$.isOSX?"3px":"2px";
}else{
this.dropDownButton.style.top="2px";
...
if(O$.isIE&&!O$.isIE90&&!O$.isIE80&&!O$.isIE70){
this.textInput.style.marginTop="-1px";
...
function(selection){
if(O$.isIE90){
$wt.widgets.Text.setTextSelection(this.textInput,selection.x,selection.y+1);
}else{
...
if((this.style&8)!=0&&!this.isSimple){
Clazz.removeEvent(this.textInput,"click",this.hEditShow);
}this.hEditShow=null;
