...
this.size=100;
if((this.style&256)!=0){
this.createHorizontalScrollBar(this.parent.scrolledHandle(),this.size,$_dI(this.size*(this.maximum-this.minimum)/this.thumb));
}else{
this.createVerticalScrollBar(this.parent.scrolledHandle(),this.size,$_dI(this.size*(this.maximum-this.minimum)/this.thumb));
...
this.sbHandle.style.fontSize=$_dI(this.increment*(this.maximum-this.minimum)/this.thumb)+"px";
...
function(){
var innerSize=Math.round($_dI(this.size*(this.maximum-this.minimum)/this.thumb));
if((this.style&512)!=0){
...
if((this.style&256)!=0){
this.sbHandle.scrollLeft=$_dI((this.selection-this.minimum)*this.sbHandle.scrollWidth/(this.maximum-this.minimum));
}else{
this.sbHandle.scrollTop=$_dI((this.selection-this.minimum)*this.sbHandle.scrollHeight/(this.maximum-this.minimum));
}}});
$_M(c$,"dispose",
function(){
...
if(this.maximum!=this.minimum){
if((this.style&256)!=0){
this.selection=this.minimum+$_dI(this.sbHandle.scrollLeft*(this.maximum-this.minimum)/this.sbHandle.scrollWidth);
}else{
this.selection=this.minimum+$_dI(this.sbHandle.scrollTop*(this.maximum-this.minimum)/this.sbHandle.scrollHeight);
