...
this.hsPicker.style.left=$_dI(h*198/239)+"px";
this.hsPicker.style.top=$_dI((240-s)*172/240)+"px";
this.lPicker.style.top=$_dI((240-l-5)*172/240)+"px";
...
this.hsPicker.style.left=$_dI(hsl.h*198/239)+"px";
this.hsPicker.style.top=$_dI((240-hsl.s)*172/240)+"px";
this.lPicker.style.top=$_dI((240-hsl.l-5)*172/240)+"px";
this.updateColorStrip(hsl.h,hsl.s);
},"~N,~N,~N");
$_M(c$,"updateColorStrip",
function(h,s){
for(var i=0;i<this.colorStrips.length;i++){
var l=240-$_dI(i*240/29);
var rgb=new $wt.widgets.ColorDialog.HSL(h,s,l).toRGB();
...
l=this.b$["$wt.widgets.ColorDialog"].constrain(this.b$["$wt.widgets.ColorDialog"].lText,240);
e.sourceElement.style.top=(172-$_dI(l*172/240)-5)+"px";
return true;
...
var h=$_dI((e.x-pt.x)*239/198);
var s=240-$_dI((e.y-pt.y)*240/172);
...
var l=240-$_dI((e.y-pt.y)*240/172);
this.b$["$wt.widgets.ColorDialog"].lText.value=""+l;
var h=this.b$["$wt.widgets.ColorDialog"].constrain(this.b$["$wt.widgets.ColorDialog"].hText,239);
var s=this.b$["$wt.widgets.ColorDialog"].constrain(this.b$["$wt.widgets.ColorDialog"].sText,240);
l=this.b$["$wt.widgets.ColorDialog"].constrain(this.b$["$wt.widgets.ColorDialog"].lText,240);
...
b=j[1];
c=j[2];
}}return new $wt.graphics.RGB($_dI(255*a),$_dI(255*b),$_dI(255*c));
});
$_M(c$,"fromRGB",
function(a){
var b=(a.red/255);
