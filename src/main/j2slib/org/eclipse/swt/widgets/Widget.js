...
this.hookedStatus=$_Ab(38,false);
}var hooked=false;
...
$_M(c$,"fixMnemonic",
function(string){
var buffer=$_AC(string.length,'\0');
...
Clazz.addEvent(this.hookHandle(),"keydown",this.hKeyDown);
this.hookKeyPress();
});
$_M(c$,"hookKeyPress",
($fz=function(){
...
Clazz.addEvent(this.hookHandle(),"keypress",this.hKeyPress);
...
Clazz.addEvent(this.hookHandle(),"keyup",this.hKeyUp);
this.hookKeyPress();
});
$_M(c$,"mouseHoverProc",
function(clear){
...
Clazz.addEvent(this.hookHandle(),"mousedown",this.hMouseDown);
});
$_M(c$,"hookMouseUp",
function(){
...
Clazz.addEvent(this.hookHandle(),"mouseup",this.hMouseUp);
});
$_M(c$,"hookMouseMove",
function(){
...
Clazz.addEvent(this.hookHandle(),"mousemove",this.hMouseMove);
});
$_M(c$,"hookMouseEnter",
function(){
...
Clazz.addEvent(this.hookHandle(),"mouseover",this.hMouseEnter);
});
$_M(c$,"hookMouseExit",
function(){
...
Clazz.addEvent(this.hookHandle(),"mouseout",this.hMouseExit);
});
...
Clazz.addEvent(this.hookHandle(),"dblclick",this.hMouseDoubleClick);
});
$_M(c$,"hookSelection",
function(){
...
Clazz.addEvent(this.hookHandle(),"click",this.hSelection);
});
$_M(c$,"hookFocusIn",
function(){
...
Clazz.addEvent(this.hookHandle(),"focus",this.hFocusIn);
});
$_M(c$,"hookFocusOut",
function(){
...
Clazz.addEvent(this.hookHandle(),"blur",this.hFocusOut);
});
$_M(c$,"hookModify",
function(){
...
Clazz.addEvent(this.hookHandle(),"change",this.hModify);
});
$_M(c$,"hookHelp",
function(){
if(this.hHelp!=null){
...
Clazz.addEvent(this.hookHandle(),"help",this.hHelp);
});
$_M(c$,"hookArm",
function(){
});
...
Clazz.addEvent(this.hookHandle(),"contextmenu",this.hMenuDetect);
});
$_M(c$,"hookMouseWheel",
function(){
});
...
this.state|=1;
this.display=null;
var hookHdl=this.hookHandle();
if(this.handle!=null&&hookHdl!=null){
if(this.hFocusIn!=null){
Clazz.removeEvent(hookHdl,"focus",this.hFocusIn);
this.hFocusIn=null;
}if(this.hFocusOut!=null){
Clazz.removeEvent(hookHdl,"blur",this.hFocusOut);
this.hFocusOut=null;
}if(this.hKeyDown!=null){
Clazz.removeEvent(hookHdl,"keydown",this.hKeyDown);
this.hKeyDown=null;
}if(this.hKeyUp!=null){
Clazz.removeEvent(hookHdl,"keyup",this.hKeyUp);
this.hKeyUp=null;
}if(this.hKeyPress!=null){
Clazz.removeEvent(hookHdl,"keypress",this.hKeyPress);
this.hKeyPress=null;
}if(this.hMouseDown!=null){
Clazz.removeEvent(hookHdl,"mousedown",this.hMouseDown);
this.hMouseDown=null;
}if(this.hMouseUp!=null){
Clazz.removeEvent(hookHdl,"mouseup",this.hMouseUp);
this.hMouseUp=null;
}if(this.hMouseEnter!=null){
Clazz.removeEvent(hookHdl,"mouseover",this.hMouseEnter);
this.hMouseEnter=null;
}if(this.hMouseExit!=null){
Clazz.removeEvent(hookHdl,"mouseout",this.hMouseExit);
this.hMouseExit=null;
}if(this.hMouseDoubleClick!=null){
Clazz.removeEvent(hookHdl,"dblclick",this.hMouseDoubleClick);
this.hMouseDoubleClick=null;
}if(this.hMouseMove!=null){
Clazz.removeEvent(hookHdl,"mousemove",this.hMouseMove);
this.hMouseMove=null;
}if(this.hMouseWheel!=null){
Clazz.removeEvent(hookHdl,"scroll",this.hMouseWheel);
this.hMouseWheel=null;
}if(this.hSelection!=null){
Clazz.removeEvent(hookHdl,"click",this.hSelection);
this.hSelection=null;
}if(this.hMenuDetect!=null){
Clazz.removeEvent(hookHdl,"contextmenu",this.hMenuDetect);
this.hMenuDetect=null;
}if(this.hModify!=null){
Clazz.removeEvent(hookHdl,"change",this.hModify);
this.hModify=null;
}if(this.hHelp!=null){
Clazz.removeEvent(hookHdl,"help",this.hHelp);
this.hHelp=null;
}}if(this.handle!=null){
