...
this.offsets=new Array($_dI(length/4));
this.ids=new Array($_dI(length/4));
this.mnemonics=$_AI($_dI(length/4)+1,0);
var result=$_AC(0,'\0');
var result2=$_AC(0,'\0');
var buffer=$_AC(length,'\0');
...
this.ids=newIDs;
var newMnemonics=$_AI(linkIndex+1,0);
