...
var height=border*2;
if((this.style&256)!=0){
width+=$_dI(16*(this.maximum-this.minimum)/this.pageIncrement);
height+=24;
}else{
width+=24;
height+=$_dI(16*(this.maximum-this.minimum)/this.pageIncrement);
...
if((this.style&256)!=0){
if(size.x<=64){
borderWidth=$_dI(size.x*20/64);
}trackWidth=size.x-borderWidth*2;
var thumbWidth=$_dI(this.thumb*trackWidth/(this.maximum-this.minimum));
if(thumbWidth>16){
thumbWidth-=2;
...
this.selection=$_dI((thumbPosition-borderWidth)*(this.maximum-this.minimum)/trackWidth)+this.minimum;
}else{
if(size.y<=64){
borderWidth=$_dI(size.y*20/64);
...
var thumbPosition=$_dI((this.selection-this.minimum)*trackWidth/(this.maximum-this.minimum))+borderWidth;
...
if(this.isHorizontal){
if(gWidth<=64){
borderWidth=$_dI(gWidth*20/64);
}var thumbWidth=$_dI(this.b$["$wt.widgets.Slider"].thumb*(gWidth-borderWidth*2)/(this.b$["$wt.widgets.Slider"].maximum-this.b$["$wt.widgets.Slider"].minimum));
if(thumbWidth>16){
thumbWidth-=2;
}else if(thumbWidth>12){
thumbWidth--;
