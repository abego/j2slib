...
handleStyle.marginLeft=(($_dI(width/2))-1)+"px";
handleStyle.height=height+"px";
this.handle.childNodes[1].style.marginLeft=($_dI(width/2))+"px";
...
}var y=this.image.packedOffsetY-$_dI((cy-this.image.packedItemHeight)/2);
if((this.style&16384)!=0){
this.handle.style.backgroundPosition="-"+this.image.packedOffsetX+"px -"+y+"px";
}else if((this.style&16777216)!=0){
this.handle.style.backgroundPosition="-"+(this.image.packedOffsetX-$_dI((cx-this.image.packedItemWidth)/2))+"px -"+y+"px";
;}else if((this.style&131072)!=0){
