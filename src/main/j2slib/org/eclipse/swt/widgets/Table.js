...
function(){
var result=$_AI(this.selection.length,0);
...
if(this.items[this.lastIndexOf-1]===item)return--this.lastIndexOf;
}if(this.lastIndexOf<$_dI(count/2)){
for(var i=0;i<count;i++){
...
function(indices){
if(indices.length==0)return;
var newIndices=$_AI(indices.length,0);
