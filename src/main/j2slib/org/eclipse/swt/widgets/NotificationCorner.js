...
this.handle.className="tray-logo-item tray-logo-item-round";
var title="Powered by Java2Script";
{
if(window["swt.logo.tooltip"]!=null){
title=window["swt.logo.tooltip"];
}
}this.handle.title=title;
...
this.handle.style.backgroundImage="url('"+logoURL+"')";
}}if(this.display.taskBar.handle!=null){
this.display.taskBar.handle.appendChild(this.handle);
}else{
d$.body.appendChild(this.handle);
}if(this.logoOrientation==131072){
this.handle.style.left=(this.display.taskBar.clientWidth-36-18-6)+"px";
}else{
this.handle.style.left="12px";
}if(this.display.taskBar.orientation==1024){
this.handle.style.top=(this.display.taskBar.clientHeight-36)+"px";
}else{
...
$_V(c$,"updateLayout",
function(){
if(this.display.tray!=null&&!this.display.tray.isDisposed()){
this.display.tray.updateItems();
}if(this.handle!=null&&this.display!=null&&this.display.taskBar!=null&&(this.display.taskBar.orientation==1024||this.display.taskBar.orientation==128)){
if(this.logoOrientation==131072){
this.handle.style.left=(this.display.taskBar.clientWidth-36-18-6)+"px";
}else{
this.handle.style.left="12px";
