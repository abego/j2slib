...
function(){
var newX=this.bounds.x+$_dI(this.bounds.width/2);
...
x=$_dI((rects[i].x-this.bounds.x)*100/this.bounds.width);
width=$_dI(rects[i].width*100/this.bounds.width);
}else{
width=100;
}if(this.bounds.height!=0){
y=$_dI((rects[i].y-this.bounds.y)*100/this.bounds.height);
height=$_dI(rects[i].height*100/this.bounds.height);
}else{
height=100;
...
for(var i=0;i<this.rectangles.length;i++){
var proportion=this.proportions[i];
newRects[i]=new $wt.graphics.Rectangle($_dI(proportion.x*this.bounds.width/ 100) + this.bounds.x, $_dI (proportion.y * this.bounds.height /100)+this.bounds.y,$_dI(proportion.width*this.bounds.width/ 100), $_dI (proportion.height * this.bounds.height /100));
}
