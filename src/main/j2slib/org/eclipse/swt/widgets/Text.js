...
return $_U(this,$wt.widgets.Text,"getEnabled",[]);
}});
$_M(c$,"getEditable",
function(){
...
b=4;
}else if(O$.isIE&&!O$.isIE70&&!O$.isIE80&&!O$.isIE90){
b=4;
}}}this.textHandle.style.height=(cy-b>0?cy-b:0)+"px";
if((this.style&(66))!=0){
if(O$.isIE&&!O$.isIE70&&!O$.isIE80&&!O$.isIE90&&b!=0){
b+=2;
}else if(O$.isIE70){
b-=2;
...
var ev=new $wt.widgets.Event();
if(this.b$["$wt.widgets.Text"].hooks(24)&&this.b$["$wt.widgets.Text"].textValue!==this.b$["$wt.widgets.Text"].textHandle.value){
this.b$["$wt.widgets.Text"].textValue=this.b$["$wt.widgets.Text"].textHandle.value;
ev.type=24;
ev.widget=this.b$["$wt.widgets.Text"];
ev.display=this.b$["$wt.widgets.Text"].display;
