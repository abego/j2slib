...
var page=Math.max(1,$_dI(rect.height/height));
...
var imageY=$_dI((size.y-imageSize.height)/2);
...
break;
case 16777216:
x+=$_dI((bounds.width-x-extent.x)/2);
break;
}
}}else{
...
break;
case 16777216:
x+=$_dI((bounds.width-x-extent.x)/2)+2;
break;
}
}}var textY=$_dI((size.y-extent.y)/2);
