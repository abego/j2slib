...
var imageX=xDraw;
var imageY=this.y+$_dI((this.height-imageBounds.height)/2);
...
var textY=this.y+$_dI((this.height-extent.y)/2);
...
var d=this.parent.tabHeight-$_dI(this.parent.topCurveHighlightEnd.length/2);
var lastX=0;
var lastY=0;
var lastColorIndex=0;
for(var i=0;i<$_dI(leftHighlightCurve.length/2);i++){
...
for(var i=0;i<$_dI(this.parent.topCurveHighlightStart.length/2);i++){
...
for(var i=0;i<$_dI(this.parent.topCurveHighlightEnd.length/2);i++){
...
var imageY=this.y+$_dI((this.height-imageHeight)/2);
imageY+=this.parent.onBottom?-1:1;
var imageWidth=$_dI(imageBounds.width*imageHeight/imageBounds.height);
...
var imageY=this.y+$_dI((this.height-bounds.height)/2)+(this.parent.onBottom?-1:1);
