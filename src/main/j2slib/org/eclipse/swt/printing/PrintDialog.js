...
var y=$_dI((this.dialogShell.getMonitor().getBounds().height-size.y)/2)-20;
if(y<0){
y=0;
}this.dialogShell.setLocation($_dI((this.dialogShell.getMonitor().getBounds().width-size.x)/2),y);
