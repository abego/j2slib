...
if(java.io.InputStream.skipBuf==null||java.io.InputStream.skipBuf.length<toRead)($t$=java.io.InputStream.skipBuf=$_AB(toRead,0),java.io.InputStream.prototype.skipBuf=java.io.InputStream.skipBuf,$t$);
while(skipped<n){
