...
if($_e(e,java.util.NoSuchElementException)){
throw new ArrayIndexOutOfBoundsException();
}else{
throw e;
}
...
function(collection){
var c=collection;
return(($_D("java.util.Collections$1")?0:java.util.Collections.$Collections$1$()),$_N(java.util.Collections$1,this,$_F("c",c)));
...
$_M(c$,"listIterator",
function(a){
return(($_D("java.util.Collections$UnmodifiableList$1")?0:java.util.Collections.UnmodifiableList.$Collections$UnmodifiableList$1$()),$_N(java.util.Collections$UnmodifiableList$1,this,$_F("a",a)));
},"~N");
$_M(c$,"remove",
function(a){
throw new UnsupportedOperationException();
...
$_Y(c$,function(){
this.iterator=this.b$["java.util.Collections.UnmodifiableList"].list.listIterator(this.f$.a);
});
$_V(c$,"add",
function(b){
throw new UnsupportedOperationException();
