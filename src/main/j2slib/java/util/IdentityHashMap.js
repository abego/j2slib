...
($fz=function(){
return($_dI((this.threshold*10000)/7500))*2;
...
return((System.identityHashCode(key)&0x7FFFFFFF)%($_dI(length/2)))*2;
...
$_M(c$,"computeMaxSize",
($fz=function(){
this.threshold=($_dI(($_dI(this.elementData.length/ 2)) * 7500 /10000));
},$fz.isPrivate=true,$fz));
$_V(c$,"remove",
function(key){
if(key==null){
