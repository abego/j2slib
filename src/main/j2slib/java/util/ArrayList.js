...
if($_e(e,NegativeArraySizeException)){
...
this.firstIndex=this.lastIndex=0;
this.array=this.newElementArray(size+($_dI(size/10)));
...
}else if((location<$_dI(size/2)&&this.firstIndex>0)||this.lastIndex==this.array.length){
...
}else if((location<$_dI(size/2)&&this.firstIndex>0)||this.lastIndex>this.array.length-growSize){
